...
**Generated:** 2026-05-25 22:17 UTC  
...
**Annix Geo H2 simulation**
- 1-D coupled multiphase Darcy + 5-reaction redox kinetics + Monte Carlo classifier (n=200).
...
wells in the southern-AB bbox (expected — outside the oil sands area).
Section 2 is analyst-authored — Claude tool-use generation runs once
`ANTHROPIC_API_KEY` is configured on the production pipeline.*
